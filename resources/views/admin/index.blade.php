            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="#revenue-chart" data-toggle="tab">Histograma</a>
                    </li>
                    <li class="nav-item">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  <div class="chart tab-pane" id="sales-chart" style="position: relative; height: 220px;">
                    <canvas id="sales-chart-canvas" height="220" style="height: 220px;"></canvas>
                  </div>
                </div>
              </div><!-- /.card-body -->
            </div>
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  ...
                  <div class="col-4 text-center">
                    ...
                    <div class="text-white">Alquileres</div>
                  </div>
                  <!-- ./col -->
                </div>
                <!-- /.row -->
