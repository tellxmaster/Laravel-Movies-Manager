				...
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						<div class="float-left">
							<h4><i class="fas fa-film text-danger"></i>
					...
					<table class="table table-bordered table-sm">
						...
						<tbody>
							...
							<tr>
								...
								<td><img src="storage/uploads/logo-small.png"></td>
								<td width="90">
								<div class="btn-group">
									...
									<a class="dropdown-item" onclick="confirm('Confirma Eliminar Pelicula id {{$row->id}}? \nUna vez eliminada la Pelicula no se puede recuperar!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Eliminar </a>   
									</div>
								</div>
								</td>
							@endforeach
